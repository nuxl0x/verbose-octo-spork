...
verbose-octo-spork is a CLI primarily programmed in Bash, with some Python.
...
This is one of my first projects and I would really appreciate it.

Primary executable: /usr/local/bin/vos
Share folder: /usr/local/share/vos
Assets folder: /usr/local/share/vos/assets
Commands folder: /usr/local/share/vos/commands
